import {IIngredient, IUser, TFeedDetailedOrder, TFeedOrders, TProfileDetailedOrder} from "./types";
...
export const singleOrderRequest = (orderNumber: number) => {
